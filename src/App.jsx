...
function App() {
  ...
  return (
      <div className='bg-slate-950 w-screen min-h-screen flex justify-center items-center flex-col' > 
        
        <h5 className='font-bold text-white text-center text-2xl m-10'>INSCRIPCION SERVICIO DE AVIVAMIENTO FAMILIAR - Domingo 27 de Octubre del 2024</h5>
        <div className="w-[350px] md:w-[800px] text-white mb-6">
          ...
          <p className="mb-4">Te invitamos a diligenciar este formulario de inscripción para asistir a nuestras celebraciones:
            ...
            <h5 className="text-2xl mb-4 font-bold text-white">Indicaciones para Inscripción</h5>
        <div className="w-[350px] md:w-[800px] text-white mb-6">
            <ol>
                <li className="mb-4">1. Inscríbete lo más rápido posible, no lo dejes para lo último, Dios bendice tu interés y diligencia!</li>
                <li className="mb-4">2. Puedes compartir este link para invitar personas nuevas, que han dejado de asistir a la iglesia, miembros regolares, etc.</li>
